...
from myMetrics import f1_score, bad_case
...
#     'I-Drugs'
# ]
        #print(metrics.classification_report(true_tags, pred_tags, labels=Labels))
        bad_case(true_tags, pred_tags, sent_data)
        f1_labels, f1 = f1_score(true_tags, pred_tags, mode)
        metrics1['f1_labels'] = f1_labels
        metrics1['f1'] = f1
    metrics1['loss'] = float(dev_losses) / len(dev_loader)
    return metrics1
