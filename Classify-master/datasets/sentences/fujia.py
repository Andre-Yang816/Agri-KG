...
# 使用示例
file1 = '/home/ypx/project/ypx/Agriculture_projects/BertClassifier-master/datasets/entities/new_long_texts_entities.txt'  # 第一个文件路径

file2 = '/home/ypx/project/ypx/Agriculture_projects/BertClassifier-master/datasets/sentences/new_sentences.txt'  # 第二个文件路径
output_file = 'merged_sentences.txt'  # 输出文件路径
