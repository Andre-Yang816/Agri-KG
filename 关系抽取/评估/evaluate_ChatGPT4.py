...
log_dir = 'logs/chatGPT4.log'

# Set up logging
logging.basicConfig(filename=log_dir, level=logging.INFO)

# Example data (replace with your actual data)
with open('/home/ypx/project/ypx/Agriculture_projects/关系抽取任务/chatGPT4/pred/pred1.json', 'r', encoding='utf-8') as f:
...
logging.info("****ChatGPT4.0 Prediction Evaluation Report****")
...
print("****ChatGPT4.0 Prediction Evaluation Report****")
