...
def train():
    ...
    # sentence_graph.pkl    title + sentence + graph
    #需修改的三条
    model_name = 'sentence_graph_entity.pkl'
    log_dir = '/home/ypx/project/ypx/Agriculture_projects/分类实验/logs/sentence_graph_entity.log'
    train_path = '/home/ypx/project/ypx/Agriculture_projects/分类实验/datas/sentence_graph/train_data.json'
    val_path = '/home/ypx/project/ypx/Agriculture_projects/分类实验/datas/sentence_graph/val_data.json'
    ...
    for epoch in range(1, epochs + 1):
        ...
        for batch in train_bar:
            ...
            inputs, labels = batch
            title_input, entity_input, sentence_input, gra_input = inputs
            ...
            gra_input =  {key: val.to(device) for key, val in gra_input.items()}
            labels = labels.to(device)
            output = model(title_input, entity_input, sentence_input, gra_input)
